<x-layout>
    ...
    <div
        ...
        <div class="space-y-8 w-[50%] flex flex-col items-center justify-center">
            ...
            <p class="text-center text-xl text-balance font-semibold">Competitive Programming Competition is a contest
                where participants are required to solve complex algorithmic problems within a specified time frame.
                Competitors write code to solve these problems, focusing on correctness, efficiency, and speed. All
                competitions are conducted online.</p>
        </div>

        <div class="flex flex-row items-center justify-center space-x-10 w-auto py-10">
            <a href="https://drive.google.com/file/d/1d2Y6ryvdkKka1MtdKjUf6j-fMJ1mGZZ4/view?usp=sharing" target="_blank"
                rel="noopener noreferrer"><x-button textSize="text-2xl" textPadding="p-1">Booklet</x-button></a>
            <a href="https://bit.ly/IFEST_COMPROG2024" target="_blank" rel="noopener noreferrer"><x-button
    ...
    <div
        ...
        <div class="space-y-4 mx-5 flex flex-col items-center justify-center">
            ...
            <p class="text-center text-md text-wrap font-semibold" style="color: rgb(12 40 62);">Competitive Programming
                Competition is a contest where participants are required to solve complex algorithmic problems within a
                specified time frame. Competitors write code to solve these problems, focusing on correctness,
                efficiency, and speed. All competitions are conducted online.</p>
        </div>

        <div class="flex flex-row items-center justify-center space-x-10 w-auto py-10">
            <a href="https://drive.google.com/file/d/1d2Y6ryvdkKka1MtdKjUf6j-fMJ1mGZZ4/view?usp=sharing" target="_blank"
                rel="noopener noreferrer"><x-button-mobver>Booklet</x-button-mobver></a>
            <a href="https://bit.ly/IFEST_COMPROG2024" target="_blank"
