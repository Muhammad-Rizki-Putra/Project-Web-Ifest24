...
<x-slot:pagename>{{$pagename}}</x-slot:pagename>
    <div class="hidden md:flex items-center justify-center flex-col h-auto bg-itcomp-bg bg-fixed bg-right-bottom bg-cover bg-no-repeat py-20">
        ...
        <div class="flex flex-row items-center justify-center space-x-10 w-auto py-10">
            <a href="https://drive.google.com/file/d/1rFQ_-hhx-zNSBgpZT6rEEV1ZNACH5Rqf/view?usp=drive_link"><x-button textSize="text-2xl" textPadding="p-1">Booklet</x-button></a>
            <a href="http://bit.ly/IFEST_WEBDEV2024"><x-button textSize="text-2xl" textPadding="p-1">Registration</x-button></a>
        </div>
    ...
    <div class="md:hidden flex items-center justify-center flex-col h-auto bg-itcomp-bg bg-fixed bg-right-bottom bg-cover bg-no-repeat py-20">
        ...
        <div class="flex flex-row items-center justify-center space-x-10 w-auto py-10">
            <a href="https://drive.google.com/file/d/1rFQ_-hhx-zNSBgpZT6rEEV1ZNACH5Rqf/view?usp=drive_link"><x-button-mobver>Booklet</x-button-mobver></a>
