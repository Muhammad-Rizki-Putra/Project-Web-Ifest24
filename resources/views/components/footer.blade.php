<div class="hidden md:flex flex-row items-start justify-evenly w-full h-auto bg-cream-bg p-5">
    ...
    <div class="flex flex-col items-center justify-start">
        <h1 class="text-xl pb-2 font-bold">Contacts</h1>
        <div>
            <div class="flex flex-row">
                <img src="/image/Email.png" alt="logo-email" class="mr-2 object-none">
                <p>marketing.ifest@gmail.com</p>
            </div>

            <div class="flex flex-row">
                <img src="/image/Telephone.png" alt="logo-telpon" class="mr-2 object-none">
                <p>Rafa (082261552004)</p>
            </div>
        </div>
    </div>

    <div class="flex flex-col items-center justify-center">
        <h1 class="text-xl pb-2 text-nowrap font-bold">Social Media</h1>
...
<div class="md:hidden flex flex-col w-screen h-auto items-start justify-start bg-cream-bg px-5">
    <div class="flex flex-col items-start pt-3">
        <h1 class="text-lg text-nowrap font-bold pb-2 ">Brought To You By</h1>
    ...
    <div class="flex flex-col items-start justify-start pt-3">
        <h1 class="text-lg font-bold pb-2">Contacts</h1>
        <div class="grid grid-rows-2 gap-2">
            <div class="flex flex-row">
                <img src="/image/Email.png" alt="logo-email" class="mr-2 object-none">
                <p class="text-sm">marketing.ifest@gmail.com</p>
            </div>

            <div class="flex flex-row">
                <img src="/image/Telephone.png" alt="logo-telpon" class="mr-2 object-none">
                <p class="text-sm">Rafa (082261552004)</p>
            </div>
        </div>
    </div>
