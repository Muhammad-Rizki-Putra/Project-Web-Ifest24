<div class="flex flex-row items-start justify-center w-full h-auto bg-cream-bg space-x-64  p-5">
    <div class="flex flex-col items-center justify-center">
        <h1 class="text-xl pb-3 text-nowrap font-bold">Brought To You By</h1>
    ...
    <div class="flex flex-col items-center justify-center">
        <h1 class="text-xl pb-3 text-nowrap font-bold">Partner Links</h1>
    </div>

    <div class="flex flex-col items-center justify-start">
        <h1 class="text-xl pb-3 font-bold">Contacts</h1>
        <div>
