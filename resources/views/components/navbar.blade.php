<nav class="bg-cream-bg" x-data="{ isOpen: false }">
    ...
    <div class="-mr-2 flex md:hidden items-center justify-center">  
        <div class="absolute flex items-center justify-start w-screen">
    ...
    <div :class="{'hidden' : !isOpen, 'block' : isOpen}" class="md:hidden transition" id="mobile-menu">
