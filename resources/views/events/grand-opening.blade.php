...
<x-slot:pagename>{{$pagename}}</x-slot:pagename>
    <div class="hidden md:flex items-center justify-center flex-col h-auto  bg-home-bg bg-cover bg-no-repeat bg-fixed bg-left py-20 gap-y-32">
        ...
        <div class="bg-white bg-opacity-60 rounded-xl shadow-lg p-6 w-full max-w-lg">
        ...
        <div class="bg-navy-bg rounded-xl shadow-lg p-6 w-full max-w-lg">
            <p class="text-center text-white text-3xl font-medium">Sunday, August 25th 2024!</p>
        </div>
    ...
    <div class="md:hidden flex items-center justify-center flex-col h-auto bg-home-bg bg-cover bg-no-repeat bg-fixed bg-right-bottom py-20 gap-y-32">
        ...
        <div class="bg-navy-bg rounded-xl shadow-lg p-6 w-auto max-w-lg mx-7">
            <p class="text-center text-white text-xl font-medium">Sunday, August 25th 2024!</p>
        </div>

        <div class="mx-5">
            <div class="bg-transparent p-6 w-auto max-w-lg mx-7">
