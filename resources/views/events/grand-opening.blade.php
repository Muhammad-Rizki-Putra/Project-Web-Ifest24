...
<x-slot:pagename>{{$pagename}}</x-slot:pagename>
    <div class="hidden md:flex items-center justify-center flex-col h-auto bg-home-bg bg-cover bg-no-repeat bg-fixed bg-left py-20 gap-y-16">
        ...
        <div class="bg-white bg-opacity-60 rounded-xl shadow-lg p-6 w-full max-w-2xl">
            <p class="text-center text-gray-800 text-lg font-medium">The IFest 2024 Premiere Launch is a series of opening events featuring an online talk show concept. This activity aims to serve as a platform that enables Founders or Strategic Partners from several companies operating in the Artificial Intelligence and Financial Technology sectors, as well as experts and specialists in those fields, to meet with participants and share experiences and knowledge related to the industry.</p>
        </div>
        ...
        <div class="flex flex-col items-center w-full">
            ...
            <a href="https://www.instagram.com/ifestunpad/" target="_blank" rel="noopener noreferrer" class="w-full max-w-md">
        ...
        <div class="flex flex-col items-center w-full">
            ...
            <a href="http://bit.lt/SCIFest" target="_blank" rel="noopener noreferrer" class="w-full max-w-md">
                <div class="bg-transparent rounded-xl p-3 w-full flex flex-row items-center justify-center gap-x-3 outline outline-2 outline-offset-2 outline-navy-bg">
    ...
    <div class="md:hidden flex items-center justify-center flex-col h-auto bg-home-bg bg-cover bg-no-repeat bg-fixed bg-right-bottom py-20 gap-y-16">
        ...
        <div class="bg-white bg-opacity-60 rounded-xl shadow-lg p-6 w-auto max-w-lg mx-7">
            <p class="text-center text-gray-800 text-md font-medium">The IFest 2024 Premiere Launch is a series of opening events featuring an online talk show concept. This activity aims to serve as a platform that enables Founders or Strategic Partners from several companies operating in the Artificial Intelligence and Financial Technology sectors, as well as experts and specialists in those fields, to meet with participants and share experiences and knowledge related to the industry.</p>
        </div>
        ...
        <div class="mx-5 flex flex-col justify-center items-center w-full">
            <div class="bg-transparent p-6 w-auto max-w-lg mx-2">
                <p class="text-center text-black text-md font-medium">To receive more details, please keep an eye on our Instagram!</p>
            </div>

            <a href="https://www.instagram.com/ifestunpad/" target="_blank" rel="noopener noreferrer" class="w-auto max-w-sm">
                <div class="bg-transparent rounded-xl p-3 w-80 max-w-lg flex flex-row items-center justify-center gap-x-3 outline outline-2 outline-offset-2 outline-navy-bg">
        ...
        <div class="mx-5">
            ...
            <a href="http://bit.lt/SCIFest" target="_blank" rel="noopener noreferrer" class="w-full max-w-sm">
                <div class="bg-transparent rounded-xl w-80 max-w-lg flex flex-row items-center justify-center gap-x-3 outline outline-2 outline-offset-2 outline-navy-bg">
