<x-layout>
    ...
    <div x-data="{ selected: 'rh-la1' }">
        <div
            class="hidden md:flex items-center justify-center flex-col h-auto bg-itcomp-bg bg-fixed bg-right-bottom bg-cover bg-no-repeat gap-y-10 px-[25%]">

            <div class="flex items-center justify-center flex-col h-[calc(100vh-99px)] top-0 gap-10">
                <div>
            ...
            <div x-show="selected === 'rh-la1'"
                class="md:flex items-center justify-center flex-col h-auto py-20 gap-y-20"
        ...
        <div
            ...
            <div x-show="selected === 'rh-la1'"
                ...
                <div>
                    <a href="http://bit.lt/SCIFest" class="w-full">
                        <div
                            class="bg-transparent rounded-xl w-full max-w-lg flex flex-row items-center justify-center gap-x-3 outline outline-4 outline-offset-2 outline-navy-bg p-5 group">
                            <p
                                class="text-center text-navy-bg group-hover:text-cream-bg transition duration-150 text-xl font-medium text-nowrap">
