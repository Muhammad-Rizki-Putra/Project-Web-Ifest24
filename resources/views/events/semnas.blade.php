<x-layout>
    ...
    <div class="hidden md:flex items-center justify-center flex-col h-auto bg-itcomp-bg bg-fixed bg-right-bottom bg-cover bg-no-repeat py-20 gap-y-10 px-[25%]">

        <div>
            <h1 class="text-6xl font-bold">SEMINAR NASIONAL</h1>
        </div>

        <div>
            <h1 class="text-4xl font-semibold text-center">Exploring Career Path In Technology: Navigating Challenges and Opportunities</h1>
        </div>

        <div>
            <h1 class="text-lg text-center">With the end of the pandemic, the startup trend that had been growing has seen a decline over the past two years. Additionally, issues like Artificial Intelligence potentially replacing programmer jobs have emerged. So, as job opportunities in the IT field decrease, is pursuing a career in this field still worth it?</h1>
        </div>

        <!-- Semnas -->
        <div class="md:flex items-center justify-center flex-col h-auto py-20 gap-y-20">
            <div>
                <h1 class="text-4xl font-bold text-center text-wrap">Our Seminar Speakers</h1>
            </div>

            <div class="grid grid-cols-2 grid-rows-1 gap-x-10">
                <div class="w-[320px] h-[400px] bg-white">
