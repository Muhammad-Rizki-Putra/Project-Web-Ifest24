<x-layout2>
    ...
    <div class="w-full h-screen flex items-center justify-center bg-home-bg bg-cover bg-no-repeat bg-center">
        <div class="bg-cream-bg p-8 rounded-lg max-w-md w-full text-center forgot-pass">
            ...
            <div class="text-lg font-medium text-slate-700 mb-6">Enter Your New Password</div>
            
            <div class="mb-4">
                <input type="text" placeholder="Enter Your Password" class="w-full p-4 mb-4 rounded-lg bg-gray-100 text-slate-600 focus:outline-none focus:ring-2 focus:ring-slate-400">
                <input type="text" placeholder="Enter Your Confirmation" class="w-full p-4 rounded-lg bg-gray-100 text-slate-600 focus:outline-none focus:ring-2 focus:ring-slate-400">
            </div>
