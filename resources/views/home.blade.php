        ...
        <div class="flex flex-col px-[125px] pt-[25vh] justify-center">
            ...
            <div class="flex flex-col justify-center pt-[116px]">
                ...
                <div class="flex flex-row items-center justify-center gap-x-20">
                    ...
                    <div class="gallery">
                        <div class="gallery-container gallery-5 flex flex-col items-center">
                            <div>
                                <img src="/image/Lomba/CTF.png" alt="box"
                                    class="bg-cream-bg rounded-lg w-auto h-[250px] gallery-item  gallery-item-1"
                                    data-index="1">
                                <img src="/image/Lomba/Comprog.png" alt="box"
                                    class="bg-cream-bg rounded-lg w-auto h-[250px] gallery-item  gallery-item-2"
                                    data-index="2">
                                <img src="/image/Lomba/DAC.png" alt="box"
                                    class="bg-cream-bg rounded-lg w-auto h-[250px] gallery-item  gallery-item-3"
                                    data-index="3">
                                <img src="/image/Lomba/Incomp.png" alt="box"
                                    class="bg-cream-bg rounded-lg w-auto h-[250px] gallery-item  gallery-item-4"
                                    data-index="4">
                                <img src="/image/Lomba/Webdev.png" alt="box"
                                    class="bg-cream-bg rounded-lg w-auto h-[250px] gallery-item  gallery-item-5"
                                    data-index="5">
                            </div>
        ...
        <div class="flex flex-col px-[5vh] pt-[5vh] justify-center">
            ...
            <div class="flex flex-col items-center pt-[116px]">
                ...
                <p class="text-xl text-center max-w-[1191px]">
                    IFest is an annual event presented by Himatif FMIPA Unpad, which carries the essence of IT and aims
                    to serve as a platform for the development of participants' potential. IFest 2023 consists of
                    several series, namely Talkshow, Technopreneur, National Seminar, IT Competition, Awarding Night,
                    and Company Expo.
                </p>
            </div>
            ...
            <div class="flex flex-col justify-center pt-[116px]">
                ...
                <div class="flex flex-row items-center justify-center gap-10">
                    ...
                    <div class="control-buttons">
                        <button id="carousel-3-nextButton"><img src="/image/next.png" alt=""
                                class="h-auto w-auto"></button>
                    </div>
                </div>
            </div>
        </div>
